...
public class LwM2mPath {
    ...
    public boolean startWith(LwM2mPath start) {
        ...
        if (start.getObjectId() == null)
            return true;
        if (start.getObjectId() != this.getObjectId()) {
            return false;
        }
        // object instance id
        if (start.getObjectInstanceId() == null)
            return true;
        if (start.getObjectInstanceId() != this.getObjectInstanceId()) {
            return false;
        }
        // resource id
        if (start.getResourceId() == null)
            return true;
        if (start.getResourceId() != this.getResourceId()) {
            return false;
        }
        // resource instance id
        if (start.getResourceInstanceId() == null)
            return true;
        if (start.getResourceInstanceId() != this.getResourceInstanceId()) {
            return false;
        }
        return true;
    }
